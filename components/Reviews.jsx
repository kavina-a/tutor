const conversations = [
  {
    ...
    tag: 'IGCSE Maths',
    bubbles: [
      { side: 'them', text: "You've helped me improve so much over the past few months and I want to say thank you so much for all the support \u2764\uFE0F" },
      { side: 'them', text: 'Would definitely recommend you to any student looking for a tutor' },
      { side: 'me',   text: "Thank you so much for your kind words! It's truly been a pleasure teaching you and I'm amazed by how much you've grown since we started \uD83D\uDE0A" },
    ],
  },
  {
    label: 'the results',
    ...
    bubbles: [
      ...
      { side: 'them', text: 'A* IN MATHS!!!! \uD83D\uDE2D\uD83D\uDE2D\uD83D\uDE2D' },
      { side: 'me',   text: 'YES!! I knew you could do it! So proud of you \uD83C\uDF89' },
  ...
  },
  {
    ...
    bubbles: [
      ...
      { side: 'them', text: 'like ACTUALLY understood it, not just memorised the steps' },
      { side: 'me',   text: "That's the goal! Once it clicks, it never un-clicks \uD83D\uDE0A" },
  ...
  },
  {
    ...
    bubbles: [
      ...
      { side: 'them', text: 'just got a 9 in my mocks \uD83D\uDE2D\uD83C\uDF89' },
      { side: 'them', text: "my teacher couldn't believe it was me" },
      { side: 'me',   text: "I'm not surprised at all! You put in the work and it paid off. So proud of you \uD83D\uDCAA" },
    ],
  },
  {
    label: 'the jump',
    ...
    bubbles: [
      ...
      { side: 'me',   text: '170 point jump! That\'s incredible work. You earned every single point \uD83D\uDCAA' },
    ],
  },
];
  ...
  return (
    <section id="reviews" className="section section--black">
      <div className="reviews-header">
        <span className="section-label section-label--light">STUDENT REVIEWS</span>
      ...
      <div className="chat-arena" id="chatArena" data-lenis-prevent>
        ...
        <div className="chat-indicator">
          ...
          <span className="chat-hint" id="chatHint">swipe to explore &#x2192;</span>
        </div>
      </div>
    </section>
  );
